    ...
    <section style={{ background: '#fff', padding: '24px 0 40px' }}>
      <div className="container grid-3">
        ...
        <div className="card" data-testid="card-universities">
          ...
          <a className="btn btn-outline" style={{ marginTop: 16 }} href="/universities" data-testid="button-university-partnerships">University Partnerships</a>
        </div>
        ...
        <div className="card" data-testid="card-professionals">
          ...
          <a className="btn btn-primary" style={{ marginTop: 16 }} href="/professionals" data-testid="button-become-speaker">Become a Speaker</a>
        </div>
