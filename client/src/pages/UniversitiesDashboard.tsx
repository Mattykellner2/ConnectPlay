    ...
    <div className="dashboard-shell">
      ...
      <main className="main">
        ...
        <div className="tabbar">
          <div className="tab active" data-testid="tab-overview">Overview</div>
          <div className="tab" data-testid="tab-speakers">Guest Speakers</div>
          <div className="tab" data-testid="tab-students">Student Management</div>
          <div className="tab" data-testid="tab-codes">Access Codes</div>
        </div>
        ...
        <div className="panel-grid">
          ...
          <section className="panel">
            ...
            <div style={{ marginTop: 12 }}>
              <button 
                className="btn-red" 
                onClick={() => setLocation("/universities/dashboard/settings")}
